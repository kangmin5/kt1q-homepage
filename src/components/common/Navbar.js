...
const navigation = [
  { name: '회사소개', href: '/intro/introduce', current: false },
  { name: '사업안내', href: '/business/bangcash', current: false },
  { name: '게시판', href: '/board/board', current: false },
  { name: '회원메뉴', href: '/member/member', current: false },
]

function className(...classNamees) {
  return classNamees.filter(Boolean).join(' ')
}

const Navbar = () => {
  return (
    <div classNameName="w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800">
